  ...
  return (
    <section className="w-full h-full flex flex-col items-start gap-y-4 py-6 basic-container px-2 sm:px-2 md:px-4 xl:px-0">
      ...
      <div className="max-w-[750px] mx-auto flex flex-col items-start gap-y-4 w-full">
        ...
        <p className="w-full text-left">
          Atezz offers a shopping experience as easy as possible. We have
          relationships with various companies, organizations and entities whose
          products or services may be listed on Atezz. If any of those products
          or services are purchased through the links on this website, then
          Atezz may be compensated. It may happen that shops compensate us to
          help promote their products or services so that they are easier to
          find.
        </p>
      </div>
    </section>
